...
export const metadata = {
  title: "Нашата мисия - информация, на която може да се доверите",
  description:
    "Обединяваме лекари и учени, за да ви предоставим здравна информация, която е точна, разбираема и полезна.",
  openGraph: {
    title: "Нашата мисия - информация, на която може да се доверите",
    description:
      "Обединяваме лекари и учени, за да ви предоставим здравна информация, която е точна, разбираема и полезна.",

...
export const metadata = {
  title: "Намерете проучване, подходящо за вас - Здраве и Болест",
  description: "Филтрирайте по заболяване и терапевтична област. Открийте възможност за иновативно лечение.",

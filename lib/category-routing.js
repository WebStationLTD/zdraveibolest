...
export const CATEGORY_ICONS = {
  пулмология: "/therapeutic-icons/pulmonology.webp",
  ревматология: "/therapeutic-icons/rheumatology.webp",
  кардиология: "/therapeutic-icons/cardiology.webp",
  неврология: "/therapeutic-icons/neurology.webp",
  нефрология: "/therapeutic-icons/nephrology.webp",
  гастроентерология: "/therapeutic-icons/gastroenterology.webp",
  ендокринология: "/therapeutic-icons/endocrinology.webp",
  онкология: "/therapeutic-icons/oncology.webp",
  алергология: "/therapeutic-icons/allergology.webp",
  дерматология: "/therapeutic-icons/dermatology.webp",
  хематология: "/therapeutic-icons/hematology.webp",
  "акушер-гинекология": "/therapeutic-icons/obstetrics-gynecology.webp",
};
...
export function isPodcastCategory(category, slug) {
  ...
  return normalized === "подкасти" || normalized.includes("podcast");
}
